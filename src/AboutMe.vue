        ...
        <v-col>
          ...
          >
            <v-card-text class="my-5">
              ...
              <div class="text--primary">
                ...
                I am looking for full time employment any time after graduation and part time employment any time before then. <br>
                I have experience in full stack web development and some experience in Android development
              </div>
            </v-card-text>
          </v-card>
          ...
          >
            <v-card-text class="my-5">
              ...
              <div class="text--primary">
                ...
                I feel truly blessed that I was able to find a career path that involves doing something that I love. 
              </div>
            </v-card-text>
          </v-card>
          ...
          >
            <v-card-text class="my-5">
              ...
              <div class="text--primary">
                I've always love the outdoors, and New Mexico is the perfect place for people like me! <br>
                I grew up riding dirt bikes and mountain bikes. As a teen, I also picked snowboarding, a great way to spend the winter months! <br>
                As a student here at BYU (without a dirt bike or mountain bike) I've started running a lot more. I also enjoy drawing, painting, and playing video games.
              </div>
            </v-card-text>
          </v-card>
        </v-col>
